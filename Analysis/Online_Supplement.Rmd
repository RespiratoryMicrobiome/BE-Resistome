...
```
#########################################
#Fig. E9 - qPCR analysis of bacterial burden
```{r, warning = FALSE, message = FALSE}
...
```
#Fig. E10 - Network analysis; see online methods
```{r, warning = FALSE, message = FALSE}
knitr::include_graphics("../Data/R_input_files/Figure_E10.png")

```
#Fig. E11 - qPCR analysis of PsA burden (Eradication)
```{r, warning = FALSE, message = FALSE}
#Fig. E11####
#Re-load data
qPCR <-read.csv("../Data/R_input_files/qPCR_data_R.csv") %>%
