...
pacman::p_load(pacman, ggplot2, tidyverse, tidyr, vegan, RColorBrewer, ggpubr)
```
...
G<-ggplot(gg) +
  ...
  scale_x_reverse()
#PERMANOVA - timeToexacerbation
adonis2(AMRLT_diversity~TmToNxtEx , data = LTDiversityViz, method = "bray",  permutations=9999, strata = LTDiversityViz$TypeSamplesB)
